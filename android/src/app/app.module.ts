...
export function providers() {
  return [
    ...
    Device,/*AndroidFullScreen,*/SocialSharing, ImagePicker, DatePicker, AndroidPermissions, StatusBar, SplashScreen, Toast, OneSignal, FileTransfer, File, Transfer, Camera, FilePath, Network, AppVersion, Market,
